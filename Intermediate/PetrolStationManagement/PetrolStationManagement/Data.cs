...
namespace PetrolStationManagement
{
    ...
    class Data
    {
        ...
        {
            Random.RandomVehicleGenerator();
            Random.RandomFuelGenerator();
            Random.RandomRefuelTime();

            // queue limit

            // creates a vehicle with a random vehicle type, fuel type and refuel time
            Vehicle vehicle = new Vehicle(StaticVariables.randomVehicleType, StaticVariables.randomFuelType, StaticVariables.randomRefuelTime);
